...
| --- | --- |
| `yuekey_0.6.0-1_amd64.deb` **或 / or** `yuekey_0.6.0-1_arm64.deb` | 一個檔案包含全部 YueKey 元件及 CPU 語音模型／All YueKey components and CPU speech models |
...
```bash
sudo apt install ./dist/yuekey_0.6.0-1_$(dpkg --print-architecture).deb
